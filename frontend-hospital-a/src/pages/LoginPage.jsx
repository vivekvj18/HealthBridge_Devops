...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isRegister) {
        // Hardcoded to DOCTOR role and HOSP-A for Hospital A portal
        await register(form.username, form.password, 'DOCTOR', '', 'HOSP-A', form.fullName, form.specialization);
  ...
  return (
    <div className="login-page">
      <div className="login-left">
        <div className="login-left-bg" style={{background: 'linear-gradient(135deg, var(--c-navy) 0%, var(--c-primary-dark) 100%)'}} />
        ...
        <div className="login-left-content">
          ...
          <h1 className="login-hero-title">
            City General<span> Hospital</span>
          </h1>
        ...
        >
          <div>
            ...
            <p className="login-card-subtitle" style={{ marginTop: '4px' }}>
              {isRegister
                ? 'Register to access City General clinical systems'
